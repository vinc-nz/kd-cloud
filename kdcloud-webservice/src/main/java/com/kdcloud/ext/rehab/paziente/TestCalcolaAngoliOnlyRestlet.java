...
public class TestCalcolaAngoliOnlyRestlet extends RehabServerResource {

	public static final String URI = "/rehab/calcolaangoli";
	...
	public Representation acceptItem(Representation entity) {
		...
		try {
			...
			CalibrationController.F_MIN = paziente.getF_MIN();
			CalibrationController.F_MAX = paziente.getF_MAX();
			CalibrationController.F_ZERO = paziente.getF_ZERO();
			CalibrationController.B_MIN = paziente.getB_MIN();
			CalibrationController.B_MAX = paziente.getB_MAX();
			CalibrationController.B_ZERO = paziente.getB_ZERO();
			...
			d = XMLUtils.createXMLResult("calcolaangoliOutput", map, d);

		} catch (Exception e) {
			result = XMLUtils.createXMLError("errore calcolo angoli", ""
					+ e.getMessage());
		}
