 ...
 */
public class Instances implements Serializable, Iterable<Instance> {
	...
	public AttributeStats attributeStats(int index) {
		...
		if (attribute(index).isNumeric()) {
			result.numericStats = new com.kdcloud.weka.core.Stats();
		}
	...
	public boolean addAll(Instances i) {
		if (!equalHeaders(i))
			return false;
		for (Instance instance : i) {
			if (!m_Instances.add(instance))
				return false;
		}
		return true;
	}
